...
export const getMessageSnackbarText = state => state[NAME].messagesSnackbarMsg;
...
export const isMessageSnackbarVisible = state => state[NAME].messagesSnackbarVisible;